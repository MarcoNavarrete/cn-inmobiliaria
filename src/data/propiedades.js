...
const propiedades = [
  ...
  },
  {
  ...
  },
   {
    ...
    precio: '$2,995,000 MXN (a tratar)',
    ubicacion: 'Calle de Fernandez de lizardi #1001, Col Buenos Aires, Pachuca de Soto, Hidalgo',
    latitud: 20.116717,
    longitud: -98.717642,
    descripcion: 'Si estás buscando una casa amplia, funcional y bien ubicada, esta opción en Pachuca te va a encantar.' +
    'Ubicada a solo 10 minutos del centro de Pachuca, en una zona tranquila y estratégica, esta propiedad es ideal para familias grandes o para quienes necesitan espacio real para vivir y trabajar.' +
    'En la planta baja cuenta con sala, comedor, recepción, baño de visitas, una habitación perfecta para oficina o estudio, cocina, cuarto de lavandería, patio trasero y cochera para tres autos.' +  
    'En el segundo nivel encontrarás cinco habitaciones en total, incluyendo una habitación principal con baño completo y vestidor, estancia familiar, baño completo adicional y amplios espacios de guardado. Un diseño pensado para comodidad, privacidad y convivencia.' +
    'La casa colinda por un lado con una calle y por el otro con un bioparque, lo que brinda mayor privacidad, vistas agradables y un entorno natural difícil de encontrar tan cerca de la ciudad.' +
    'Una propiedad ideal para crecer en familia, trabajar desde casa o disfrutar de espacios amplios en una excelente ubicación.',
    caracteristicas: [
    { tipo: 'simple', texto: '267 m² de terreno' },
    { tipo: 'simple', texto: '255.24 m² de construcción' },
    { tipo: 'simple', texto: 'Valor en el mercado: $3,600,000 MXN' },
    { tipo: 'simple', texto: 'Año de terminación: 1993' },
    { tipo: 'simple', texto: 'V.U.R.: 456' },
    {
      tipo: 'grupo',
      titulo: 'Planta Baja',
      opciones: [
    ...
    },
    {
      ...
      titulo: 'Planta Alta',
      opciones: [
        'Habitación principal con baño completo y armario completo',
    ...
    imagenes: [
      './assets/casa_fernando_l/imagen1.jpg',
      './assets/casa_fernando_l/imagen2.jpg',
      './assets/casa_fernando_l/imagen3.jpg',
      './assets/casa_fernando_l/imagen4.jpg',
      './assets/casa_fernando_l/imagen5.jpg',
      './assets/casa_fernando_l/imagen6.jpg',
      './assets/casa_fernando_l/imagen7.jpg',
      './assets/casa_fernando_l/imagen8.jpg',
      './assets/casa_fernando_l/imagen9.jpg',
      './assets/casa_fernando_l/imagen10.jpg',
      './assets/casa_fernando_l/imagen11.jpg',
      './assets/casa_fernando_l/imagen12.jpg',
      './assets/casa_fernando_l/imagen13.jpg',
      './assets/casa_fernando_l/imagen14.jpg',
      './assets/casa_fernando_l/imagen15.jpg',
      './assets/casa_fernando_l/imagen16.jpg',
      './assets/casa_fernando_l/imagen17.jpg',
      './assets/casa_fernando_l/imagen18.jpg',
      './assets/casa_fernando_l/imagen19.jpg',
      './assets/casa_fernando_l/imagen20.jpg',
      './assets/casa_fernando_l/imagen21.jpg',
      './assets/casa_fernando_l/imagen22.jpg',
      './assets/casa_fernando_l/imagen23.jpg',
      './assets/casa_fernando_l/imagen24.jpg',
      './assets/casa_fernando_l/imagen25.jpg',
      './assets/casa_fernando_l/imagen26.jpg',
      './assets/casa_fernando_l/imagen27.jpg',
      './assets/casa_fernando_l/imagen28.jpg',
      './assets/casa_fernando_l/imagen29.jpg',
      './assets/casa_fernando_l/imagen30.jpg',
      './assets/casa_fernando_l/imagen31.jpg',
      './assets/casa_fernando_l/imagen32.jpg',
      './assets/casa_fernando_l/imagen33.jpg',
      './assets/casa_fernando_l/imagen34.jpg',
      './assets/casa_fernando_l/imagen35.jpg',
      './assets/casa_fernando_l/imagen36.jpg',
    ],
  },
  {
    id: '3',
